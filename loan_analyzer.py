...
def Average(loan_costs):
    return sum(loan_costs)/len(loan_costs)

average = Average(loan_costs)

print("The average loan amount is =", round(average, 2))
...
print("The months remaining are=", remaining_months)
...
with open (csvpath. 'w', newline='') as csvfile:
    ...
    for row in inexpensive_loans:
            csvwriter.writerow(row.values(header))